...
void CChat::OnMessage(int MsgType, void *pRawMsg)
{
	if(MsgType == NETMSGTYPE_SV_CHAT)
	{
		...
		m_pClient->m_pLua->m_pEventListener->GetParameters(EventID)->FindFree()->Set((char *)pMsg->m_pMessage);
		m_pClient->m_pLua->m_pEventListener->GetParameters(EventID)->FindFree()->Set(pMsg->m_ClientID);
		m_pClient->m_pLua->m_pEventListener->GetParameters(EventID)->FindFree()->Set(pMsg->m_Team);
